...
let PerfilController = class PerfilController {
    ...
    async getPerfil(req) {
        try {
            ...
            throw new common_1.HttpException('Erro ao buscar perfil do usuário', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
//# sourceMappingURL=cliente.perfil.controller.js.map